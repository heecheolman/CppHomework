...
public:
    Management() {
        ...
        in.open("/Users/heecheolkim/XcodeProjects/cpp/Homework3/Homework3/student.data");
        out.open("/Users/heecheolkim/XcodeProjects/cpp/Homework3/Homework3/student_result.data");
